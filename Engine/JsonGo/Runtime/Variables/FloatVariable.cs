...
namespace JsonGo.Runtime.Variables
{
    ...
    public class FloatVariable : BaseVariable, ISerializationVariable<float>
    {
        ...
        public void Initialize(TypeGoInfo<float> typeGoInfo, ITypeGo options)
        {
        ...
        public void BinarySerialize(ref BufferBuilder<byte> stream, ref float value)
        {
        ...
        /// <param name="value">value to serialize</param>
        public void JsonBinarySerialize(ref JsonSerializeHandler handler, ref float value)
        {
