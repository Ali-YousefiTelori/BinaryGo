...
namespace JsonGo.Runtime.Variables.Enums
{
        ...
        where TEnum : struct, Enum
    {
        ...
        {
            handler.TextWriter.Write(((uint)(object)value).ToString(CurrentCulture));
        }
        ...
        {
            stream.Write(BitConverter.GetBytes((uint)(object)value));
        }
        ...
        {
            return (TEnum)(object)BitConverter.ToUInt32(reader.Read(sizeof(uint)));
        }
        ...
        {
            //handler.Append(handler.EncodingGetBytes(((uint)(object)value).ToString(CurrentCulture)));
        }
    }
}
