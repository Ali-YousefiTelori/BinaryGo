...
{
    /// <summary>
    /// Enum that inheritance ushort
    /// </summary>
    public class EnumUShortVariable<TEnum> : BaseVariable, ISerializationVariable<TEnum>
         where TEnum : struct, Enum
    {
        /// <summary>
        /// default constructor to initialize
        /// </summary>
        public EnumUShortVariable() : base(typeof(TEnum))
        {
        ...
        {
            //handler.TextWriter.Write(handler.EncodingGetBytes(((ushort)(object)value).ToString(CurrentCulture)));
        }
    }
}
