...
namespace JsonGo.Runtime.Variables
{
    ...
    public class DoubleVariable : BaseVariable, ISerializationVariable<double>
    {
        ...
        public void Initialize(TypeGoInfo<double> typeGoInfo, ITypeGo options)
        {
        ...
        public void BinarySerialize(ref BufferBuilder<byte> stream, ref double value)
        {
        ...
        /// <param name="value">value to serialize</param>
        public void JsonBinarySerialize(ref JsonSerializeHandler handler, ref double value)
        {
