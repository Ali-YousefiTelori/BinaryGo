...
namespace JsonGoTest.Binary.Variables
{
    public class BinaryNormalVariablesDeserializationsTest : BinaryNormalVariablesSerializationsTest
    {
        ...
        public void ByteTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<byte>(Result) == Value);
        }
        ...
        public void SByteTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<sbyte>(Result) == Value);
        }
        ...
        public void Int16TestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<short>(Result) == Value);
        }
        ...
        public void UInt16TestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<ushort>(Result) == Value);
        }
        ...
        public void Int32TestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<int>(Result) == Value);
        }
        ...
        public void UInt32TestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<uint>(Result) == Value);
        }
        ...
        public void Int64TestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<long>(Result) == Value);
        }
        ...
        public void UInt64TestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<ulong>(Result) == Value);
        }
        ...
        public void DoubleTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<double>(Result) == Value);
        }
        ...
        public void FloatTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<float>(Result) == Value);
        }
        ...
        public void DecimalTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<decimal>(Result) == Value);
        }
        ...
        public void BoolTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<bool>(Result) == Value);
        }
        ...
        public void DateTimeTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<DateTime>(Result) == Value);
        }
        ...
        public void EnumTestDeserialize1()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<TestEnum>(Result) == Value);
        }
        ...
        public void ByteArrayTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<byte[]>(Result).SequenceEqual(Value));
        }
        ...
        public void IntArrayTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<int[]>(Result).SequenceEqual(Value));
        }
        ...
        public void StringArrayTestDeserialize()
        {
            ...
            Assert.True(JsonGo.Binary.Deserialize.BinaryDeserializer.NormalInstance.Deserialize<string[]>(Result).SequenceEqual(Value));
        }
